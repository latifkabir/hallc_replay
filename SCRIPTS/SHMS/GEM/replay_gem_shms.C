...
{   
    ...
    // Define DEF-file
    analyzer->SetOdefFile("DEF-files/SHMS/PRODUCTION/GEM/pstackana_gem.def");
    // Define cuts file
    analyzer->SetCutFile("DEF-files/SHMS/PRODUCTION/GEM/pstackana_production_cuts_gem.def");  // optional
